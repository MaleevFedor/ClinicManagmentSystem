...
JAZZMIN_SETTINGS = {
    "site_title": "Sventus Admin",
    "site_header": "Sventus Managment",
    ...
    "custom_links": {
        ...
        "Продвинутые функции": [
            {
                "name": "Расписание",
                "url": "admin:clinic_backend_timetable_changelist",
...
AUTH_USER_MODEL = 'clinic_backend.Employee'
...
CELERY_BEAT_SCHEDULE = {
    "daily-job": {
        "task": "clinic_backend.tasks.booking_link_deactivation",
